...
const Projects = () => {
  ...
  return (
    <div id="projects" className="mb-2.5">
              ...
              <div className="card w-3/5 bg-base-100 shadow-xl">
                ...
                <div className="card-body justify-center items-center text-center">
                  ...
                  <div className="card-actions">
                    <button
                      className="btn btn-primary w-full lg:w-fit md:btn-md gap-3"
                    ...
                    {typeof proj.repo !== "object" ? (
                      ...
                      proj.repo.map((r, i) => {
                        return (
                          <div
                            className="tooltip flex w-full lg:w-fit"
                            data-tip={i === 0 ? "Client Side" : "Server Side"}
                          >
                            <a
                              href={r}
                              target="_blank"
